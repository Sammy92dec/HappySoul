...
Here is a link to the live project. https://happy-soul-c0da3e42146b.herokuapp.com/

Welcome to HappySoul, where users share their favourite created recipes. 
It is built using the Django Framework in python.
...
A visitor to HappySoul would be someone who is most likely an adult who is looking to either find new recipes or to share their own creations. 

## User Stories 

A list of my user stories and their tasks can be found [here](https://github.com/Sammy92dec/HappySoul/issues).
...
[Back to top ⇧](#happysoul)

## Design
The look of this website was based loosely around The Code Institute's 'I think therefore I Blog' project.  

### Colour Scheme
- I wanted to keep the colour scheme simple. This is because the uploaded pictures from users could be any host of colours, so by keeping the colour scheme neutral the site minimises the risk of clashing with any images, keeping them the main focus of the user.

### Typography
- On the site I will be using the default bootstrap fonts as I find them clean, elegant and easy to read so I feel they will fit in with the site's theme nicely. The only font used on the site will be Kanit.
